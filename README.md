...
- **[Attention Is All You Need: The Translation Problem That Led to ChatGPT](https://dev.to/abdullahsaad5/attention-is-all-you-need-the-translation-problem-that-led-to-chatgpt-5ao9)** &nbsp;·&nbsp; Google researchers were improving machine translation. How removing recurrence cut training cost, created the Transformer, and eventually led to ChatGPT.
- **[Access vs Refresh Tokens: I Was Missing Two Ideas](https://dev.to/abdullahsaad5/access-vs-refresh-tokens-i-was-missing-two-ideas-2c55)** &nbsp;·&nbsp; I shipped a login token that lived seven years with no way to revoke it. What access and refresh tokens each actually do, where to store them, and the two ideas I was missing.
...
[![My stack](https://skillicons.dev/icons?i=ts,js,python,react,nextjs,nodejs,express,mongodb,postgres,redis,aws,docker,flutter,tailwind)](https://abdullahsaad5.github.io)
...
```txt
From: 24 August 2022 - To: 05 September 2026

Total Time: 5,223 hrs 12 mins

TypeScript                 1,894 hrs 12 mins     ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   36.27 %
JavaScript                 1,849 hrs 56 mins     ⣿⣿⣿⣿⣿⣿⣿⣿⣷⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   35.42 %
Dart                       691 hrs 14 mins       ⣿⣿⣿⣤⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   13.23 %
Markdown                   191 hrs 22 mins       ⣷⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   03.66 %
Other                      126 hrs 20 mins       ⣶⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   02.42 %
```
